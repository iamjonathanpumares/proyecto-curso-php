        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
              ...
              <input type="hidden" value="<?php echo $usuario['username']; ?>" name="username_first">
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" <?php if ($usuario['superuser'] == 1) echo 'checked'; ?> name="superuser" id="id_superuser" value="1">
                      Superusuario
                    </label>
                  </div>
