...
<div class="wrapper">
  ...
  <?php include $VIEWS_DIR . 'includes/header.view.php'; ?>
  <?php include $VIEWS_DIR . 'includes/aside.view.php'; ?>
            ...
            <form role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="username" class="form-control" id="id_username" placeholder="Ingrese un usuario">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="confirm_password" class="form-control" id="id_confirm_password" placeholder="Confirmar contraseña">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">First name</label>
                  <input type="text" name="first_name" class="form-control" id="id_first_name" placeholder="Ingrese un nombre">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Last name</label>
                  <input type="text" name="last_name" class="form-control" id="id_last_name" placeholder="Ingrese un apellido">
                </div>
                <!-- checkbox -->
                <div class="form-group">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="superuser" id="id_superuser" value="1">
                      Superusuario
                    </label>
                  </div>
                  ...
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" checked name="active" id="id_active" value="1">
                      Activo
                    </label>
                  </div>
                </div>
  ...
  <!-- /.content-wrapper -->
  <?php include $VIEWS_DIR . 'includes/footer.view.php'; ?>
